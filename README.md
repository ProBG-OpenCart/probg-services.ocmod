...
`dist/probg-services-1.1.0.ocmod.zip`
...
- enquiry list and detail pages;
- workflow statuses;
- administrator assignment;
- filters including assignee;
- internal notes;
- customer email replies from the enquiry page;
- history showing administrator and whether an entry was sent to the customer;
...
OpenCart 4 will use a separate installable package while preserving the same service/category/enquiry domain contract. See `docs/ARCHITECTURE.md` and `docs/COMPATIBILITY.md`.

## Installation

1. Download `probg-services-1.1.0.ocmod.zip` from GitHub Releases or `dist/`.
...
Версия `1.1.0` добавя назначаване на запитвания към администратори и директни email отговори към клиента, като вътрешните бележки и изпратените отговори се разграничават в историята.
